...
export default function FileIcon({ item }: { item: string }) {
	...
	const extensionMap: { [key: string]: FileTypeInfo } = {
		...
		".cs": {
			icon: <SiSharp className="text-purple-600" />,
			category: "code",
			canOpen: true,
			description: "C#",
		},
		...
		// Archivos web
		".html": {
			icon: <BsFiletypeHtml className="text-orange-600" />,
			category: "code",
			canOpen: true,
			description: "HTML",
		},
		".css": {
			icon: <BsFiletypeCss className="text-blue-500" />,
			category: "code",
			canOpen: true,
			description: "CSS",
		},
		".scss": {
			icon: <BsFiletypeCss className="text-pink-500" />,
			category: "code",
			canOpen: true,
			description: "Sass",
		},
		".sass": {
			icon: <BsFiletypeCss className="text-pink-600" />,
			category: "code",
			canOpen: true,
			description: "Sass",
		},
		...
		".json": {
			icon: <BsFiletypeJson className="text-yellow-300" />,
			category: "data",
			canOpen: true,
			description: "JSON",
		},
		".xml": {
			icon: <BsFiletypeXml className="text-green-600" />,
			category: "data",
			canOpen: true,
			description: "XML",
		},
		".yaml": {
			icon: <BsFiletypeYml className="text-red-500" />,
			category: "config",
			canOpen: true,
			description: "YAML",
		},
		...
		".csv": {
			icon: <MdTableChart className="text-green-400" />,
			category: "data",
			canOpen: true,
			description: "CSV",
		},
		...
		// Archivos de texto
		".txt": {
			icon: <FaFileLines className="text-gray-300" />,
			category: "text",
			canOpen: true,
			description: "Text File",
		},
		".md": {
			icon: <TbMarkdown className="text-blue-300" />,
			category: "text",
			canOpen: true,
		...
		".doc": {
			icon: <FaFileWord className="text-blue-700" />,
			category: "document",
			canOpen: false,
		...
		".zip": {
			icon: <FaFileZipper className="text-yellow-600" />,
			category: "archive",
			canOpen: false,
			description: "ZIP Archive",
		},
		".pdf": {
			icon: <BsFileEarmarkPdf className="text-red-500" />,
			category: "archive",
			canOpen: false,
			description: "ZIP Archive",
		},
		".rar": {
			icon: <FaFileArchive className="text-purple-600" />,
			category: "archive",
			canOpen: false,
			description: "RAR Archive",
		},
		".7z": {
			icon: <FaFileArchive className="text-orange-600" />,
			category: "archive",
			canOpen: false,
			description: "7-Zip Archive",
		},
		".tar": {
			icon: <FaFileArchive className="text-gray-600" />,
			category: "archive",
			canOpen: false,
		...
		".gif": {
			icon: <FaFileImage className="text-pink-500" />,
			category: "image",
			canOpen: false,
			description: "GIF Image",
		},
		".svg": {
			icon: <TbFileTypeSvg className="text-orange-500" />,
			category: "image",
			canOpen: false,
			description: "SVG Vector",
		},
		".bmp": {
			icon: <FaFileImage className="text-blue-400" />,
			category: "image",
			canOpen: false,
			description: "Bitmap Image",
		},
		".webp": {
			icon: <FaFileImage className="text-purple-400" />,
			category: "image",
			canOpen: false,
		...
		".wav": {
			icon: <MdAudioFile className="text-blue-600" />,
			category: "audio",
			canOpen: false,
			description: "WAV Audio",
		},
		".flac": {
			icon: <FaFileAudio className="text-yellow-600" />,
			category: "audio",
			canOpen: false,
			description: "FLAC Audio",
		},
		".ogg": {
			icon: <FaFileAudio className="text-purple-600" />,
			category: "audio",
			canOpen: false,
		...
		".avi": {
			icon: <MdVideoFile className="text-blue-600" />,
			category: "video",
			canOpen: false,
		...
		".mov": {
			icon: <FaFileVideo className="text-gray-600" />,
			category: "video",
			canOpen: false,
