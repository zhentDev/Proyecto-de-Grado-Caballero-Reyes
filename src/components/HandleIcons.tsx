...
import { PiFileCsv, PiFileTxt, PiFolderStarLight } from "react-icons/pi";
...
export default function FileIcon({ item }: { item: string }) {
	...
	if (folderIcons[item as keyof typeof folderIcons])
		return folderIcons[item as keyof typeof folderIcons];
