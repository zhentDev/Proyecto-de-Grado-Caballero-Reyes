    ...
    if ((e && typeof e == "object") || typeof e == "function")
      for (const i of Ne(e))
        !Be.call(t, i) &&
          ...
          le(t, i, {
            get: () => e[i],
            enumerable: !(r = Fe(e, i)) || r.enumerable,
          });
    return t;
  };
  var $e = (t, e, n) => (
    ...
    je(
      e || !t || !t.__esModule
        ? le(n, "default", { value: t, enumerable: !0 })
        : n,
      t
    )
  );
    ...
    (function () {
      ...
      (t.tokenizer = (e, n) => {
        ...
        for (
          ...
          var l = r.charAt(o),
            c = o - a;
          if (l.match(t.tokenizer.delimiter) || o == i) {
            if (c > 0) {
...
`,
      ...
      (t.Index = function (e) {
        ...
        (t.Index.prototype.query = function (e) {
          ...
          for (
            var V = t.Set.complete, M = t.Set.empty, l = 0;
            l < this.fields.length;
            l++
          ) {
            var y = this.fields[l];
      ...
      (t.Builder = function () {
            ...
            for (var b = 0; b < d.length; b++) {
              ...
              for (var y = 0; y < this.metadataWhitelist.length; y++) {
                var S = this.metadataWhitelist[y],
                  w = v.metadata[S];
                this.invertedIndex[v][o][r][S] == null &&
                  (this.invertedIndex[v][o][r][S] = []),
        ...
        (t.QueryLexer.termdelimiter = t.tokenizer.delimiter),
        (t.QueryLexer.lexText = (e) => {
          for (;;) {
            ...
            if (n.match(t.QueryLexer.termdelimiter))
